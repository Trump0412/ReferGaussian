        ...
        entities.append(
            {
                ...
                "stage1_object_id": proposal_entity.get("stage1_object_id") if proposal_entity is not None else None,
                "stage1_track_id": proposal_entity.get("stage1_track_id") if proposal_entity is not None else None,
                "stage1_instance_group_id": proposal_entity.get("stage1_instance_group_id") if proposal_entity is not None else None,
                "stage1_instance_index": proposal_entity.get("stage1_instance_index") if proposal_entity is not None else None,
